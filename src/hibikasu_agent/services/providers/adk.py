...
def run_review(prd_text: str) -> list[ApiIssue]:
    """Run the ADK parallel review pipeline once and return ApiIssue list."""
    try:
...
async def answer_dialog_from_issue(issue: ApiIssue, question_text: str) -> str:
